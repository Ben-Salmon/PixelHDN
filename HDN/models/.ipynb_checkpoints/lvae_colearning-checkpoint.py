...
from HDN.lib.likelihoods_colearning import (GaussianLikelihood, NoiseModelLikelihood)
...
class LadderVAE(LightningModule):
    ...
    def __init__(self,
        ...
        self.val_count=0
        self.num_gaussians = noiseModel.num_gaussians
        
        self.scale = nn.Parameter(torch.normal(torch.zeros([self.num_gaussians, self.img_shape[0], self.img_shape[1]]), 1), requires_grad=True)
    ...
    def forward(self, x):
        ...
        ll, likelihood_info = self.likelihood(out, x, self.scale)
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_elbo', elbo, prog_bar=False)
        return elbo
