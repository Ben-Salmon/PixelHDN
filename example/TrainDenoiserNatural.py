...
model = LadderVAE(z_dims=z_dims,
                  ...
                  img_shape=img_shape,
                  img_folder='../dn_checkpoint/MRI/HDN/natural/imgs')

checkpoint_path = '../dn_checkpoint/MRI/HDN/natural'
...
trainer.save_checkpoint('../dn_checkpoint/MRI/HDN/natural/final_params.ckpt')