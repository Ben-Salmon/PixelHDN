...
model = LadderVAE(z_dims=z_dims,
                  ...
                  img_shape=img_shape,
                  img_folder='../dn_checkpoint/PAI/HDN/structured/imgs',
                  use_uncond_mode_at=use_uncond_mode_at)

checkpoint_path = '../dn_checkpoint/PAI/HDN/structured'
...
trainer.save_checkpoint('../dn_checkpoint/PAI/HDN/structured/final_params.ckpt')