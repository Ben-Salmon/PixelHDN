...
model = LadderVAE(z_dims=z_dims,
                  ...
                  img_shape=img_shape,
                  img_folder='../dn_checkpoint/PAI/HDN/natural/imgs')

checkpoint_path = '../dn_checkpoint/PAI/HDN/natural'
...
trainer.save_checkpoint('../dn_checkpoint/PAI/HDN/natural/final_params.ckpt')