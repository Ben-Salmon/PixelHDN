...
from denoisers.divnoising.divnoising.losses import loss_fn
...
class Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        if swap:
            recon = torch.transpose(recon,-1,-2)
        return recon
...
class VAELightning(pl.LightningModule):
    def __init__(self, data_mean, data_std, gaussian_noise_std=None, noise_model=None, kl_annealing = False,
                 kl_start=0, kl_annealtime=10, z_dim=64, lr=0.0001, in_channels = 1, init_filters = 32, 
